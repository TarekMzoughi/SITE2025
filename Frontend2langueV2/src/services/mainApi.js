...
class MainApiService {
  ...
  // Get all site data in one call (NEW)
  async getSiteData() {
    try {
  ...
  // Poll for configuration changes (for real-time updates)
  async pollForUpdates(lastUpdateTime) {
    return this.request(`/config/check-updates?lastUpdate=${lastUpdateTime}`);
  }
}
