    ...
    <div  className="page-container">
      <div  className="container">
        <div className="page-header">
          ...
          <p className="page-subtitle">Get in touch with the SITE Conference team</p>
        </div>
            ...
            <div style={styles.contactCard}>
              <div style={styles.contactItem}>
                ...
                <div>
                  ...
                  <p style={styles.contactText}>
                    ADT Bizerte, Institut Supérieur des Etudes Technologiques de Bizerte
                  </p>
                </div>
              </div>
              ...
              <div style={styles.contactItem}>
                ...
                <div>
                  ...
                  <p style={styles.contactText}>
                    <a href="tel:+21698954990" style={styles.link}>+216 98 954 990</a>
                  </p>
                  <p style={styles.contactText}>
                    <a href="tel:+21699909707" style={styles.link}>+216 99 909 707</a>
                  </p>
                </div>
              </div>
